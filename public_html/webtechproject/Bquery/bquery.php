...
if (mysqli_connect_errno())
  ...
  mysqli_query($con,"SELECT * FROM bquery");
 if (isset($_POST['comp']))
 {
 $u=$_COOKIE['user'];
 $id=$_POST['comp'];
 ...
 $reason=$_POST['reason'];
 $other=$_POST['other'];
 mysqli_query($con,"INSERT INTO bquery (Name,id,email,reason,other)
VALUES ('$u','$id','$email','$reason','$other')");
    $m='maddisiddart@gmail.com';
    $subject='BUYER QUERIES';
    $content=$u.' has issue with '.$reason.' and his other queries are '. $other.' so please contact him at '.$email;
    $head='siddartmaddi1@gmail.com';
 ...
 <link rel='shortcut icon' href='..\..\..\favicon.png'>
    ...
    <body > 
        ...
        <div id ='print' class="content">
            <form onsubmit="return results();" action='bquery.php' method='post'>
              <input id="input-1" type="text" name ='comp'placeholder="Complaint" required autofocus />
                  <label for="input-1">
              ...
              <select id="input-3" name='reason' required>
